		...
		<section class="form">
		    ...
		    <?php
		        ...
		        if (isset($_POST['submit'])) {
		          ...
		          $headers = "From: " . strip_tags($_POST['webmaster@treid.com']) . "\r\n";
		          $headers .= "Reply-To: ". strip_tags($_POST['webmaster@treid.com']) . "\r\n";
		          ...
		          $message .= 'Interested in: '.$interested_in.'<br>';
		          $message .= 'Additional Comments: '.$comments.'<br>';
		          $message .= '</body></html>';
		          $subject = 'Submission: TReid Photography';
		  ...
		  { echo "
		        ...
		        <div class='form-left'>
				    ...
				    <input type='text' required name='name' id='name' size='10'>
				    <label for='phone'>Phone</label>
				    <input type='text' required name='phone' id='phone' size='10'>
				    <label for='email'>Email</label>
				    <input type='text' required name='email' id='email' size='10'>

				</div><!--form-left-->

				<div class='form-right'>

			        <select name='interested_in' data-placeholder='I'm interested in...' class='chosen-select'>
			            <option value=''></option>
			            <option value='children'>Children Photography</option>
			            <option value='couples'>Couples Photography</option>
			            <option value='families'>Family Photography</option>
			            <option value='wedding-bridal'>Wedding and/or Bridal Photography</option>
			        </select>
					<label for='comments'>Additional Comments</label>
				    <textarea required name='comments' id='comments' size='10'></textarea>

					<div id='pot'>If you see this, leave this form field blank and invest in CSS support.
						<input type='text' name='address' value='' />
					</div><!--pot-->

			      	<button class='submit' type='submit' name='submit'>Contact Tara</button>
